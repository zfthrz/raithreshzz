...
> Interfaz de escritorio: [`docs/RACE_ENGINEER_GUI_V1_13.md`](docs/RACE_ENGINEER_GUI_V1_13.md).
...
| `race_engineer_gui.py` | v1.13 — hub de sesiones con badges de estado y comparación histórica lado a lado |
