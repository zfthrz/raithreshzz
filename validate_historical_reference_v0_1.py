...
def main() -> int:
    ap = argparse.ArgumentParser(description="Valida salida H4 historical reference selector v0.1.")
    ...
    if metadata.get("selector_version") != "0.1":
        errors.append("selector_version != 0.1")
    ...
    print("=" * 84)
    print("RACE ENGINEER - H4 HISTORICAL REFERENCE VALIDATION v0.1")
    print("=" * 84)
