...
Checkpoint: 2026-08-26 GUI v1.20 + H5.4 P1–P11 + H5.3 production gate review pending.

```text
race_engineer.py             orchestrator 0.3
race_engineer_gui.py         desktop session hub 1.20 / reversible queue recovery
