...
# ============================================================
# RACE ENGINEER - LLM ANALYSIS v3.10.7 / DeepSeek provisional v1
# ============================================================
#
# Diseñado para:
#
...
def get_validated_global_response(
    ...
    if pruned_response is not None:
        ...
        print(
            "Síntesis global: fallback determinista v3.10.7 "
            f"aplicado; se descartaron {removed_count} items "
            "opcionales no grounded."
        )
...
def save_result(
    ...
    output_path = os.path.join(
        output_dir,
        stem + f"_llm_analysis_v3_10_7_deepseek_v2_{MODEL_NAME}.json",
    )
...
def main():
    ...
    print_header(
        "RACE ENGINEER - LLM ANALYSIS v3.10.7 / DeepSeek provisional v2"
    )
