...
DISTANCE_BINS = [
    ...
    (20.0, 45.0, ">20-45m"),
    (45.0, 100.0, ">45-100m"),
    (100.0, 250.0, ">100-250m"),
    (250.0, 623.5, ">250-623.5m"),
    (623.5, float("inf"), ">=623.5m"),
]
...
def main() -> int:
    ...
    by_id = {str(p.get("pair_id")): p for p in features if isinstance(p, dict) and p.get("pair_id")}
    ...
    bin_order = [x[2] for x in DISTANCE_BINS] + ["missing", "other"]
    for b in bin_order:
