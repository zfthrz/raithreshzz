...
| `Race Engineer Scheduler.cmd` | controlador de doble clic para pausar, reanudar y consultar por separado el último ciclo real y el último disparo programado |
...
no cambian. La forma observada en la referencia se muestra además en una línea por
...
GUI v1.70 localiza las áreas principales de Historial y Estadísticas, incluidos la
referencia histórica estructurada, la comparación, tarjetas, gráficos, tabla mensual
y detalle por mes. Las subpestañas traducidas vuelven a sus claves estables antes de
...
El inspector lateral comparte una grilla estable con el workspace: puede abrirse con
el catálogo visible sin vaciar el Resumen, recompone el dashboard al terminar el
resize y envuelve también su propio título.
