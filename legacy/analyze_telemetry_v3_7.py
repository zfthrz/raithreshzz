...
# ============================================================
# RACE ENGINEER - TELEMETRY ANALYSIS v3.7
# ============================================================
#
# PYTHON:
...
# Episodios de pérdida v3.7
# Eventos sostenidos solapados o muy próximos se agrupan como una
# sola unidad temporal para evitar contar varias veces la misma pérdida.
...
def enrich_objective_v37(zones, comparison):
    enriched=[]
    for zone in zones:
        record=dict(zone)
...
def build_objective_analysis(zones, real_delta, comparison):
    ...
    return {
        ...
        "interpretation_constraints": {
            ...
            "episodes_are_primary_interpretation_units": True,
            "event_times_are_not_additive": True,
            "episode_time_is_computed_once_from_time_delta": True,
            "persistent_events_preferred_over_instantaneous_extremes": True,
            "event_priority_uses_time_loss_during_event": True,
...
def main():
    ...
    try:
            ...
            "metadata": {
                ...
                "configuration": {
                    ...
                    "objective_v37": {
                        ...
                        "loss_episode_merge_gap_m": LOSS_EPISODE_MERGE_GAP_M,
                        "min_loss_episode_time_s": MIN_LOSS_EPISODE_TIME_S,
                        "min_loss_episode_distance_m": MIN_LOSS_EPISODE_DISTANCE_M,
                        "episodes_are_primary_interpretation_units": True,
                    },
                    "event_thresholds": {
        ...
        for lap_b in comparable_laps:
            ...
            print()
            print("TOP EPISODIOS DE PÉRDIDA:")

            if loss_episode_ranking:
                for episode in loss_episode_ranking[:MAX_PRINTED_LOSS_EPISODES]:
                    channels = ",".join(
                ...
                print(
                    "  No hay episodios persistentes de pérdida."
                )
