...
> Interfaz de escritorio: [`docs/RACE_ENGINEER_GUI_V1_15.md`](docs/RACE_ENGINEER_GUI_V1_15.md).
...
| `race_engineer_gui.py` | v1.15 — hub de sesiones con sincronización plan ↔ mapa ↔ telemetría |
