...
def test_bahrain_profile_has_exact_lmu_identity_and_single_session_status() -> None:
...
def test_bahrain_single_session_profile_fails_closed_for_production_lookup() -> None:
